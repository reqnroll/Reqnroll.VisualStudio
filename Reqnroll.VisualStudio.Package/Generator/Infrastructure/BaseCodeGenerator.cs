...
namespace Reqnroll.VisualStudio.Generator.Infrastructure;
...
public abstract class BaseCodeGenerator : IVsSingleFileGenerator
{
    ...
    protected virtual void GeneratorError(uint level, string message, uint line, uint column)
    {
        ...
        if (progress != null) progress.GeneratorError(0, level, message, line, column);
    }
    ...
    {
        IVsGeneratorProgress progress = CodeGeneratorProgress;
        if (progress != null) progress.GeneratorError(1, level, message, line, column);
    }
    ...
    int IVsSingleFileGenerator.DefaultExtension(out string pbstrDefaultExtension)
    {
        ...
        {
            Debug.WriteLine("Unable to detect default extension");
